// ==UserScript==
// @name        ToolBox_Addon_PvP_Quick_Map
// @description CENTER DRIVEN Command & Conquer TA PvP Quick Map: Commander Edition as a ToolBox addon. Creates a detailed map of bases and POIs of the alliance and enemies.
...
// @icon        https://eaassets-a.akamaihd.net/cncalliancesgame/cdn/data/7d461df8a41539d221f2f9346592049b.png
// @downloadURL https://github.com/ffi82/CnC-TA/raw/master/ToolBox_Addon_PvP_Quick_Map.user.js
// @updateURL   https://github.com/ffi82/CnC-TA/raw/master/ToolBox_Addon_PvP_Quick_Map.user.js
// @contributor ffi82 (ToolBox addon mod)
// @grant none
// ==/UserScript==
/*
codes by NetquiK
        ...
        qx.Class.define("cdccta_map", {
            ...
            construct: function () {
                try {
                    ...
                    var root = this;
                    var mapButton = new qx.ui.form.Button('PvP Quick Map', 'data:image/png;base64,').set({
                        toolTipText: "CENTER DRIVEN C&C:TA PvP Quick Map - Commander Edition as a ToolBox addon. Creates a detailed map of bases and POIs of the alliance and enemies.",
                    });
                    ...
                    var onReady = function () {
                        ...
                        ToolBoxMainWindow.add(mapButton);
                    };
                ...
                __init: function () {
                    try {
                        ...
                        this.__mapButton.addListener('execute', function () {
                            root.getData();
                            cdccta_map.container.getInstance().open(1);
                        }, this);
                    } catch (e) {
                        console.log(e.toString());
                    }
                    ...
                    try {
                        ...
                        var getBases = function (pid, pn, p, tp) {
                            ClientLib.Net.CommunicationManager.GetInstance().SendSimpleCommand("GetPublicPlayerInfo", {
                                id: pid
                            }, webfrontend.phe.cnc.Util.createEventDelegate(ClientLib.Net.CommandResult, this, function (context, data) {
                                if (data.c != null) {
        ...
        qx.Class.define("cdccta_map.container", {
            ...
            construct: function () {
                try {
                    ...
                    this.panel = [zoomOut, zoomReset, zoomIn, displayOptionsC, displayMode, allianceList, editAlliance];
                    this.loader = loader;
                    this.zoomIn = zoomIn;
                    ...
                    cont.style.showMinimize = !1;
                    cont.style.showMaximize = !0;
                    cont.style.alwaysOnTop = !1;
                    canvas.style.position = 'absolute';
                    canvas.style.backgroundColor = '#0b2833';
                    canvas.style.showMinimize = !1;
                    canvas.style.showMaximize = !0;
                    canvas.style.alwaysOnTop = !1;
            ...
            members: {
                    ...
                    try {
                        ...
                        var createPoi = function (x, y, t) {
                            var c = colors.pois[t][0],
                                d = colors.pois[t][1],
                                grd = ctx.createLinearGradient(x, y - r, x, y + r);
                            grd.addColorStop(0, c);
                            grd.addColorStop(1, d);
                            ctx.beginPath();
                ...
                __enablePanel: function () {
                    for (var i = 0; i < this.panel.length; i++)
                        if (i > 1) this.panel[i].setEnabled(true);
                },
        ...
        qx.Class.define('cdccta_map.options', {
            ...
            members: {
                ...
                __saveSettings: function () {
                    ...
                    (!localStorage.cdccta_map_settings) ? localStorage['cdccta_map_settings'] = JSON.stringify(selectedAlliances): localStorage.cdccta_map_settings = JSON.stringify(selectedAlliances);
                    this.saveButton.setEnabled(false);
                    //console.log(localStorage.cdccta_map_settings);
                },
