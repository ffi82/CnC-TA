...
// @version     2025.03.02
// @author      Eistee
// @contributor NetquiK (https://github.com/netquik), TheStriker, ffi82, Nefrontheone
// @icon        http://eistee82.github.io/ta_simv2/icon.png
// @downloadURL https://github.com/ffi82/CnC-TA/raw/refs/heads/master/WarChiefs_-_Tiberium_Alliances_Upgrade_BaseDefenseArmy.user.js
// @updateURL   https://github.com/ffi82/CnC-TA/raw/refs/heads/master/WarChiefs_-_Tiberium_Alliances_Upgrade_BaseDefenseArmy.user.js
...
(function () {
    var injectFunction = function () {
        const scriptName = 'WarChiefs - Tiberium Alliances Upgrade Base/Defense/Army';
        ...
        function createClasses() {
            ...
            qx.Class.define("Upgrade.Window", {
                ...
                members: {
                    onOpen: function () {
                        webfrontend.phe.cnc.Util.attachNetEvent(ClientLib.Vis.VisMain.GetInstance(), "ViewModeChange", ClientLib.Vis.ViewModeChange, this, this.onViewModeChanged);
                        this.onViewModeChanged(null, ClientLib.Vis.VisMain.GetInstance().get_Mode());
                    },
                    onClose: function () {
                        webfrontend.phe.cnc.Util.detachNetEvent(ClientLib.Vis.VisMain.GetInstance(), "ViewModeChange", ClientLib.Vis.ViewModeChange, this, this.onViewModeChanged);
                    },
            ...
            qx.Class.define("Upgrade.All", {
                ...
                members: {
                    ...
                    onAppear: function () {
                        webfrontend.phe.cnc.Util.attachNetEvent(ClientLib.Vis.VisMain.GetInstance(), "ViewModeChange", ClientLib.Vis.ViewModeChange, this, this.onViewModeChanged);
                        webfrontend.phe.cnc.Util.attachNetEvent(ClientLib.Data.MainData.GetInstance().get_Cities(), "CurrentOwnChange", ClientLib.Data.CurrentOwnCityChange, this, this.onCurrentCityChange);
                        webfrontend.phe.cnc.Util.attachNetEvent(ClientLib.Data.MainData.GetInstance().get_Cities(), "CurrentChange", ClientLib.Data.CurrentCityChange, this, this.onCurrentCityChange);
                        webfrontend.phe.cnc.base.Timer.getInstance().addListener("uiTick", this.onTick, this);
                        this.onViewModeChanged(null, ClientLib.Vis.VisMain.GetInstance().get_Mode());
                    },
                    onDisappear: function () {
                        webfrontend.phe.cnc.Util.detachNetEvent(ClientLib.Vis.VisMain.GetInstance(), "ViewModeChange", ClientLib.Vis.ViewModeChange, this, this.onViewModeChanged);
                        webfrontend.phe.cnc.Util.detachNetEvent(ClientLib.Data.MainData.GetInstance().get_Cities(), "CurrentOwnChange", ClientLib.Data.CurrentOwnCityChange, this, this.onCurrentCityChange);
                        webfrontend.phe.cnc.Util.detachNetEvent(ClientLib.Data.MainData.GetInstance().get_Cities(), "CurrentChange", ClientLib.Data.CurrentCityChange, this, this.onCurrentCityChange);
                        webfrontend.phe.cnc.base.Timer.getInstance().removeListener("uiTick", this.onTick, this);
                    },
                    ...
                    onInput: function () {
                        ...
                        if (newLevel > 0 && costs !== null) {
                            ...
                            this.resTiberium.setLabel(webfrontend.phe.cnc.gui.util.Numbers.formatNumbersCompact(Tib) + (isFinite(TibTime) && TibTime > 0 ? " @ " + webfrontend.phe.cnc.Util.getTimespanString(TibTime) : isFinite(TibTime) ? "" : " NO GROW!"));
                            this.resTiberium.setToolTipText(webfrontend.phe.cnc.gui.util.Numbers.formatNumbers(Tib));
                            if (Tib === 0) this.resTiberium.exclude();
                            else this.resTiberium.show();

                            this.resChrystal.setLabel(webfrontend.phe.cnc.gui.util.Numbers.formatNumbersCompact(Cry) + (isFinite(CryTime) && CryTime > 0 ? " @ " + webfrontend.phe.cnc.Util.getTimespanString(CryTime) : isFinite(CryTime) ? "" : " NO GROW!"));
                            this.resChrystal.setToolTipText(webfrontend.phe.cnc.gui.util.Numbers.formatNumbers(Cry));
                            if (Cry === 0) this.resChrystal.exclude();
                            else this.resChrystal.show();

                            this.resPower.setLabel(webfrontend.phe.cnc.gui.util.Numbers.formatNumbersCompact(Pow) + (isFinite(PowTime) && PowTime > 0 ? " @ " + webfrontend.phe.cnc.Util.getTimespanString(PowTime) : isFinite(PowTime) ? "" : " NO GROW!"));
                            this.resPower.setToolTipText(webfrontend.phe.cnc.gui.util.Numbers.formatNumbers(Pow));
            ...
            qx.Class.define("Upgrade.Current", {
                ...
                members: {
                    ...
                    onAppear: function () {
                        webfrontend.phe.cnc.Util.attachNetEvent(ClientLib.Vis.VisMain.GetInstance(), "ViewModeChange", ClientLib.Vis.ViewModeChange, this, this.onViewModeChanged);
                        webfrontend.phe.cnc.Util.attachNetEvent(ClientLib.Vis.VisMain.GetInstance(), "SelectionChange", ClientLib.Vis.SelectionChange, this, this.onSelectionChange);
                        webfrontend.phe.cnc.Util.attachNetEvent(ClientLib.Data.MainData.GetInstance().get_Cities(), "CurrentOwnChange", ClientLib.Data.CurrentOwnCityChange, this, this.onCurrentCityChange);
                        webfrontend.phe.cnc.Util.attachNetEvent(ClientLib.Data.MainData.GetInstance().get_Cities(), "CurrentChange", ClientLib.Data.CurrentCityChange, this, this.onCurrentCityChange);
                        webfrontend.phe.cnc.base.Timer.getInstance().addListener("uiTick", this.onTick, this);
                        this.onViewModeChanged(null, ClientLib.Vis.VisMain.GetInstance().get_Mode());
                    ...
                    onDisappear: function () {
                        webfrontend.phe.cnc.Util.detachNetEvent(ClientLib.Vis.VisMain.GetInstance(), "ViewModeChange", ClientLib.Vis.ViewModeChange, this, this.onViewModeChanged);
                        webfrontend.phe.cnc.Util.detachNetEvent(ClientLib.Vis.VisMain.GetInstance(), "SelectionChange", ClientLib.Vis.SelectionChange, this, this.onSelectionChange);
                        webfrontend.phe.cnc.Util.detachNetEvent(ClientLib.Data.MainData.GetInstance().get_Cities(), "CurrentOwnChange", ClientLib.Data.CurrentOwnCityChange, this, this.onCurrentCityChange);
                        webfrontend.phe.cnc.Util.detachNetEvent(ClientLib.Data.MainData.GetInstance().get_Cities(), "CurrentChange", ClientLib.Data.CurrentCityChange, this, this.onCurrentCityChange);
                        webfrontend.phe.cnc.base.Timer.getInstance().removeListener("uiTick", this.onTick, this);
                    },
                ...
                members: {
                    ...
                    getInfo: function () {
                        try {
                            ...
                            this.grid.getLayout().getCellWidget(0, 2).setValue(webfrontend.phe.cnc.Util.getTimespanString(city.get_CityBuildingsData().GetFullRepairTime()));
                            this.grid.getLayout().getCellWidget(0, 4).setValue("-" + webfrontend.phe.cnc.Util.getTimespanString(win));
                            ...
                            if (city.get_CityUnitsData().GetRepairTimeFromEUnitGroup(ClientLib.Data.EUnitGroup.Infantry, false) > 0) {
                                ...
                                this.grid.getLayout().getCellWidget(1, 2).setValue(webfrontend.phe.cnc.Util.getTimespanString(city.get_CityUnitsData().GetRepairTimeFromEUnitGroup(ClientLib.Data.EUnitGroup.Infantry, false)));
                                this.grid.getLayout().getCellWidget(1, 4).setValue("-" + webfrontend.phe.cnc.Util.getTimespanString(win));
                            ...
                            if (city.get_CityUnitsData().GetRepairTimeFromEUnitGroup(ClientLib.Data.EUnitGroup.Vehicle, false) > 0) {
                                ...
                                this.grid.getLayout().getCellWidget(2, 2).setValue(webfrontend.phe.cnc.Util.getTimespanString(city.get_CityUnitsData().GetRepairTimeFromEUnitGroup(ClientLib.Data.EUnitGroup.Vehicle, false)));
                                this.grid.getLayout().getCellWidget(2, 4).setValue("-" + webfrontend.phe.cnc.Util.getTimespanString(win));
                            ...
                            if (city.get_CityUnitsData().GetRepairTimeFromEUnitGroup(ClientLib.Data.EUnitGroup.Aircraft, false) > 0) {
                                ...
                                this.grid.getLayout().getCellWidget(3, 2).setValue(webfrontend.phe.cnc.Util.getTimespanString(city.get_CityUnitsData().GetRepairTimeFromEUnitGroup(ClientLib.Data.EUnitGroup.Aircraft, false)));
                                this.grid.getLayout().getCellWidget(3, 4).setValue("-" + webfrontend.phe.cnc.Util.getTimespanString(win));
    ...
    try {
        ...
        console.log(`%cWarChiefs - Tiberium Alliances Upgrade Base/Defense/Army init error:`, 'background: black; color: pink; font-weight:bold; padding: 3px; border-radius: 5px;', e);
    }
})();
