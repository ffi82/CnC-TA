// ==UserScript==
// @name            CD SIM 2017 - Forked with Permission from TABS 2.
	...
	script.innerHTML = "(" + function () {
		function createClasses() {
			...
			qx.Class.define("TABS.RES.IMG", {							// [static]		Ressources: Images
				type : "static",
				statics : {
					Menu : "https://image.ibb.co/d8ukKa/icon.png",
					Stats : "https://image.ibb.co/fBpkKa/stats.png",
					...
					Arrows : {
						Up : "https://image.ibb.co/dLTO5F/shiftu.png",
						Down : "https://image.ibb.co/eK2GQF/shiftd.png",
						Left : "https://image.ibb.co/cdmMsv/shiftl.png",
						Right : "https://image.ibb.co/cvpVkF/shiftr.png"
					},
					Flip : {
						H : "https://image.ibb.co/cKf35F/mirror.png",
						V : "https://image.ibb.co/jHVgsv/flip.png"
					},
					DisableUnit : "https://image.ibb.co/iiaECv/disableall.png",
					Undo : "https://image.ibb.co/bVu7Xv/icon_refresh.png",
					Outcome : {
					...
					Offense : {
						Infantry : "https://image.ibb.co/kUFECv/icon_inf.png",
						Vehicle : "https://image.ibb.co/d0FQKa/icon_tnk.png",
						Aircraft : "https://image.ibb.co/eYYeea/icon_air.png"
					},
					RepairCharge : {
					...
					Simulate : "https://image.ibb.co/ckFQKa/069de63e72bddaf4b06ba9f0955ef7ef.png",
					CNCOpt : "https://image.ibb.co/nvv9ea/favicon.png",
					...
					ViewSim: "https://image.ibb.co/j2D1sv/moveunitsr.png"
				}
			});
			...
			qx.Class.define("TABS.MENU", {								// [singleton]	Menu
				...
				construct : function () {
					...
					ScriptsButton.Add("CDSIM 2017", TABS.RES.IMG.Menu, this.Menu);
					...
					var infoMenu = new qx.ui.menu.Menu(),
						...
						infoFacebook = new qx.ui.menu.Button(this.tr("Facebook"), "https://www.download3k.com/icons/Facebook-for-Android-388555.png", null);
					infoHomepage.addListener("execute", function () {
						qx.core.Init.getApplication().showExternal("https://chrome.google.com/webstore/detail/center-driven-cnc-ta-scri/glicbealjcpdfcnkjeeememcglfoafbo");
					}, this);
					infoFacebook.addListener("execute", function () {
						qx.core.Init.getApplication().showExternal("https://www.facebook.com/Center-Driven-384449795055500/");
					}, this);
			...
			qx.Class.define("TABS.GUI.ArmySetupAttackBar", {			// [singleton]	Shift and Mirror Buttons
				...
				construct : function () {
					try {
                       ...
                       // var ArmySetupAttackBar = qx.core.Init.getApplication().getArmySetupAttackBar();
                        //ArmySetupAttackBar.setMarginTop(ArmySetupAttackBar.getMarginTop() + 500);
                        ...
                        //formationContainer.setPaddingTop(formationContainer.getPaddingTop() + 20);
			...
			qx.Class.define("TABS.GUI.PlayArea", {						// [singleton]	View Simulation, Open Stats Window
				...
				construct : function () {
					try {
                        ...
                        //19.5 PATCH for Main OVERLAY
                        var PlayArea = qx.core.Init.getApplication().getMainOverlay();
                        PlayArea.setMarginBottom(PlayArea.getMarginBottom() + 90);
				...
				construct : function () {
					try {
						...
						this.set({
							...
							caption : "CDSIM: " + this.tr("Statistics"),
			...
			qx.Class.define("TABS.GUI.Window.Stats.SimView", {			//				Simulation View Objekt
				...
				construct : function (num, window) {
					try {
						...
						var ButtonAPISim = new qx.ui.form.ModelButton(null, TABS.RES.IMG.Undo).set({
								maxHeight : 22,
								minWidth : 22,
						...
						var ButtonPlay = new qx.ui.form.ModelButton(null, TABS.RES.IMG.ViewSim).set({
								maxHeight : 22,
								minWidth : 22,
			...
			try {
				if (typeof qx != 'undefined' &&
					...
					if (app !== null && app.initDone === true &&
						...
						window.setTimeout(waitForGame, 10000);
					}
				} else {
					window.setTimeout(waitForGame, 10000);
				}
