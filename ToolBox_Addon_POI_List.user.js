...
// @author         ffi82
// @description    Exports the world POI list to a .csv file. (Requires the "Tiberium Alliances Zoom" userscript.)
// @version        2024.07.21
                ...
                construct: function() {
                    try {
                        ...
                        var POIButton = new qx.ui.form.Button("POI list","data:image/png;base64,").set( {
                            toolTipText: "Export World POI list to a .csv file.",
                            width: 140,
                            height: 25,
                            maxWidth: 140,
                            maxHeight: 25,
                        ...
                        POIButton.addListener("click", function (e) {
                            if (ClientLib.Vis.VisMain.GetInstance().get_Region().get_MinZoomFactor() != 0.01) {if (confirm("Get 𝘛𝘪𝘣𝘦𝘳𝘪𝘶𝘮 𝘢𝘭𝘭𝘪𝘢𝘯𝘤𝘦𝘴 𝘡𝘰𝘰𝘮 userscript to enable true max zoom out in Region View. May reduce performance.\nAlso make sure the 'Allow max zoom out' in game Options ---> Audio/Video tab in 𝘂𝗻𝗰𝗵𝗲𝗰𝗸𝗲𝗱.")) {open("https://github.com/ffi82/CnC-TA/raw/master/Tiberium%20Alliances%20Zoom.user.js")}}
                            else {
                                if (ClientLib.Vis.VisMain.GetInstance().get_Region().get_ZoomFactor() != 0.01) {if (confirm("Set zoom factor @ 𝟬.𝟬𝟭 to be able to see the entire world...zoom out max.\nYour current zoom factor: "+ClientLib.Vis.VisMain.GetInstance().get_Region().get_ZoomFactor())){ClientLib.Vis.VisMain.GetInstance().get_Region().set_ZoomFactor(0.01)};}
                                else {
                                    if (qx.core.Init.getApplication().getPlayArea().getViewMode() != 0) {if (confirm("Switch to Region View.")){qx.core.Init.getApplication().showMainOverlay(!1)}}
                                    else {
                                        ...
                                        output += String([ClientLib.Data.MainData.GetInstance().get_Server().get_Name(),new Date().toISOString()])+"\r\n";
                                        */
                                        ...
                                        delete elLink;
                                        if (confirm("Done. ("+elLink.download+" was downloaded).\nReset zoom factor?")){ClientLib.Vis.VisMain.GetInstance().get_Region().set_ZoomFactor(1)};
                                    }
                                }
                            }
                        }, this);
