...
// @version     2024.07.21
// @description Exports the Alliance Roster to a .csv file.
// @author      ffi82
...
// @downloadURL https://github.com/ffi82/CnC-TA/raw/master/ToolBox_Addon_Alliance_Roster.user.js
                ...
                construct: function() {
                    try {
                        ...
                        Alliance_Roster_Button.addListener("click", function(e) {
                            var roster = ClientLib.Data.MainData.GetInstance().get_Alliance().get_MemberDataAsArray();
                            var c = ClientLib.Data.MainData.GetInstance().get_Alliance().get_NumMembers();
                            var data = "";
                            data += "ActiveState,AvgDefenseLvl,AvgOffenseLvl,Bases,BestDefenseLvl,BestOffenseLvl,Faction,HasControlHubCode,Id,JoinStep,LastSeen,Level,Name,OnlineState,Points,Rank,Role,RoleName,VeteranPointContribution\r\n"
                            for (var i = c - 1; i >= 0; i--) {
                                var d = roster[i];
                                data += String([d.ActiveState, d.AvgDefenseLvl, d.AvgOffenseLvl, d.Bases, d.BestDefenseLvl, d.BestOffenseLvl, d.Faction, d.HasControlHubCode, d.Id, d.JoinStep, d.LastSeen, d.Level, d.Name, d.OnlineState, d.Points, d.Rank, d.Role, d.RoleName, d.VeteranPointContribution]) + '\n'
                            }
